...
namespace SdetBootcampDay1.Exercises
{
    ...
    public class TakeHomeExercises
    {
         ...
         */
        [Test]
        public void Order1CopyOfFC24_Leaves9CopiesRemaining()
        {
         ...
         */
        [Test]
        public void Order101CopiesofFN_ShouldThrowArgumentException()
        {
            var orderHandler = new OrderHandler();
            ...
            Assert.That(aexp.Message, Is.EqualTo("Insufficient stock for item Fortnite"));
        }
         ...
         */
        [Test]
        public void AddNewStockDayOfTheTentacle_ShouldThrowArgumentException()
        {
            var orderHandler = new OrderHandler();
            var aexp = Assert.Throws<ArgumentException>(() =>
            {
            ...
            Assert.That(aexp.Message, Is.EqualTo("Unknown item DayOfTheTentacle"));
        }
